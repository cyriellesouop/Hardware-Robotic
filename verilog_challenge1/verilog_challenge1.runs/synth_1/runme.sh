...
HD_PWD='C:/Vivado/Ex_Files_Learning_Verilog_FPGA_Development/Exercise Files/Ch02/02_14/verilog_ch/verilog_ch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log is_prime.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source is_prime.tcl
